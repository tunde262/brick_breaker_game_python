...
def draw_text(text, font, text_col, x, y):
    ...
    screen.blit(img, (x, y)) # blit is used for putting images on screen in pygame
    ...
    def create_wall(self):
        ...
        for row in range(rows):
            ...
            for col in range(cols):
                # generate x an y positions for each block and create a rectangle from that
...
class Game_Ball():
    ...
    def move(self):
        ...
        if self.rect.colliderect(player_paddle):
            # check for colliding from the top
